    ...
    $input !     (
        typeswitch(.)
            ...
            case element(graphic) return
                latex:graphic($config, ., "graphic", @url, @width, @height, @scale)
                    ...
                    if (parent::table) then
                        ...
                        if (parent::lg) then
                            ...
                            if (parent::list) then
                                ...
                                if (parent::div) then
                                    latex:heading($config, ., "head5", ., @type, div)
                                else
            ...
            case element(listBibl) return
                latex:list($config, ., "listBibl", bibl)
