...
process.env.WDIO_PREFIX = process.env.WDIO_PREFIX || '/exist/apps/tei-publisher/';
...
exports.config = {
    ...
    exclude: [
        ...
        './tests/specs/edit-odd.spec.js',
        './tests/specs/generate.spec.js',
        './tests/specs/single-page.spec.js',
        './tests/specs/pdf.spec.js'
    ],
    // define test suites:
    suites: {
        dev: [
