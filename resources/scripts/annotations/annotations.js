...
window.addEventListener('WebComponentsReady', () => {
  ...
  const keyInput = document.querySelectorAll('.form-key');
  const typeInput = document.querySelectorAll('.form-type');
  const detailsInput = document.querySelectorAll('.form-details');
