            ...
            return
                    ...
                    case element(hi) return
                        if (@rend) then
                            ...
                            if (@rend='b') then
                                ...
                                if (@rendition) then
                                    fo:inline($config, ., css:get-rendition(., ("tei-hi3")), .)
                                else
                                ...
                                if (parent::table) then
                                    ...
                                    if (parent::lg) then
                                        ...
                                        if (parent::list) then
                                            ...
                                            if (parent::div) then
                                                fo:heading($config, ., ("tei-head6"), ., count($get(.)/ancestor::div))
                                            else
                    ...
                    case element(placeName) return
                        if (@rend='smallcaps') then
                            fo:link($config, ., ("tei-placeName1"), ., 'https://www.google.de/maps/place/' || @ref, map {"target": '_blank'})
                        else
                            fo:inline($config, ., ("tei-placeName2"), .)
                    case element(persName) return
                        if (@ref) then
                            fo:link($config, ., ("tei-persName1"), ., @ref, map {"target": '_blank'})
                        else
