...
module namespace model="http://www.tei-c.org/pm/models/graves/printcss";
    ...
    $input !         (
            ...
            return
                    ...
                    case element(persName) return
                        if (parent::person and (forename or surname)) then
                            ...
                            if (parent::person) then
                                ...
                                printcss:alternate($config, ., ("tei-persName3", css:map-rend-to-class(.)), ., ., id(@ref, doc("/db/apps/tei-publisher/data/register.xml")))
                    ...
                    case element(placeName) return
                        printcss:alternate($config, ., ("tei-placeName", css:map-rend-to-class(.)), ., ., id(@ref, doc("/db/apps/tei-publisher/data/register.xml")))
                    case element(term) return
                        printcss:alternate($config, ., ("tei-term", css:map-rend-to-class(.)), ., ., id(@ref, doc("/db/apps/tei-publisher/data/register.xml")))
