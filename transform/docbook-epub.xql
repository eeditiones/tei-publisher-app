            ...
            return
                    ...
                    case element(article) return
                        if ($parameters?mode='summary') then
                            epub:block($config, ., ("tei-article2"), info)
                        else
                        ...
                        if (not(parent::article or parent::book)) then
                            ...
                            if ($parameters?header='short') then
                                (
                                    ...
                                    if (author) then
                                        epub:block($config, ., ("tei-info5"), author)
                                    else
                                        ()
                                )
                                ...
                                epub:block($config, ., ("tei-info3"), (title, author))
                    ...
                    case element(title) return
                        if ($parameters?mode='summary') then
                            ...
                            return
                                                        epub:block(map:merge(($config, map:entry("template", true()))), ., ("tei-title2", "articletitle"), $content)
                        else
                    ...
                    case element(section) return
                        if ($parameters?mode='breadcrumbs') then
                            ...
                            return
                                                        epub:block(map:merge(($config, map:entry("template", true()))), ., ("tei-section3"), $content)
                    ...
                    case element(imagedata) return
                        html:graphic($config, ., ("tei-imagedata2"), ., @fileref, @width, (), (), ())
