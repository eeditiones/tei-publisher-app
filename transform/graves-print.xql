    ...
    $input !         (
            ...
            return
                    ...
                    case element(postscript) return
                        (
                            fo:heading($config, ., ("tei-postscript2"), ('Postscript by ', id(substring-after(@resp, '#'), root(.))/persName), 5),
                    ...
                    case element(place) return
                        (
                            fo:heading($config, ., ("tei-place2"), string-join(placeName, ', '), 3),
                    ...
                    case element(person) return
                        (
                            fo:heading($config, ., ("tei-person2"), persName, 3),
