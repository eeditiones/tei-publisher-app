...
module namespace model="http://www.tei-c.org/pm/models/myteisimple/epub";
                ...
                case element(div) return
                    if (@type='title_page') then
                        ...
                        if (parent::body or parent::front or parent::back) then
                            ...
                            epub:block($config, ., css:get-rendition(., ("tei-div3")), .)
