...
module namespace model="http://www.tei-c.org/pm/models/letter/epub";
            ...
            typeswitch(.)
                ...
                case element(name) return
                    if (@type='person' and @ref) then
                        (
                            ...
                            epub:note($config, ., ("tei-name2"), id(substring-after(./@ref, '#') ), (), count(preceding::name[@ref][@type='person'][ancestor::body]) + 1)
                        )

                    else
                        if (@type='place') then
                            html:link($config, ., ("tei-name3"), ., 
                ...
                case element(note) return
                    if (ancestor::person) then
                        ...
                        epub:note($config, ., ("tei-note2"), ., @place, ())
