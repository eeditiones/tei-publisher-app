    ...
    $input !         (
            ...
            return
                    ...
                    case element(gen) return
                        html:alternate($config, ., ("tei-gen", css:map-rend-to-class(.)), ., ., @norm, map {})
                    case element(pos) return
                        html:alternate($config, ., ("tei-pos", css:map-rend-to-class(.)), ., ., @norm, map {})
                    ...
                    case element(respStmt) return
                        html:alternate($config, ., ("tei-respStmt", css:map-rend-to-class(.)), ., persName, resp, map {})
