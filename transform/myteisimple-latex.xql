...
module namespace model="http://www.tei-c.org/tei-simple/models/myteisimple.odd";
                    ...
                    if (sic and corr) then
                        ...
                        if (abbr and expan) then
                            ...
                            if (orig and reg) then
                                ...
                                if (unclear) then
                                    latex:alternate($config, ., "choice7", ., if (unclear[@cert="high"]) then unclear[@cert="high"] else unclear[1], unclear[@cert!="high"])
                                else
                            ...
                            if (parent::lg) then
                                ...
                                if (parent::list) then
                                    ...
                                    if (not(parent::div/ancestor::div)) then
                                        ...
                                        if (parent::div) then
                                            latex:heading($config, ., "head6", .)
                                        else
                                            latex:block($config, ., "head7", .)
