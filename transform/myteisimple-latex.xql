(:~
    ...
    ODD: /db/apps/tei-publisher/odd/compiled/myteisimple.odd
 :)
xquery version "3.1";

module namespace model="http://www.tei-c.org/tei-simple/models/myteisimple.odd/latex";
                    ...
                    if (sic and corr) then
                        ...
                        if (abbr and expan) then
                            ...
                            if (orig and reg) then
                                ...
                                if (unclear) then
                                    latex:alternate($config, ., ("tei-choice7"), ., if (unclear[@cert="high"]) then unclear[@cert="high"]
                ...
                case element(div) return
                    if (@type='title_page') then
                        ...
                        if (parent::body or parent::front or parent::back) then
                            ...
                            latex:block($config, ., css:get-rendition(., ("tei-div3")), .)
